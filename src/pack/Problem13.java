 ...
 * Time : Thu, 9 Oct 2016, 17:35
 * Problem Statement : Work out the first ten digits of the sum of the following one-hundred 50-digit numbers..<br>
 * Goal : Work out the first ten digits of the sum of the following one-hundred 50-digit numbers.
...
public class Problem13{
 ...
 int arr[][] = {
   ...
   while(carry>0){
       ans[pointer--] = carry%10;
       carry /= 10;
   }
         
   System.out.print("The first 10-digits of the sum are : ");
   for(int i=pointer+1; i<=pointer+1+10; i++) {
